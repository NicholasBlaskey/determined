...
class GetHPImportanceResponseMetricHPImportance:
    def __init__(
        ...
        *,
        ...
        self.error = None if isinstance(error, Unset) else error
        self._error_is_set = not isinstance(error, Unset)
        self.experimentProgress = None if isinstance(experimentProgress, Unset) else experimentProgress
        self._experimentProgress_is_set = not isinstance(experimentProgress, Unset)
        self.hpImportance = None if isinstance(hpImportance, Unset) else hpImportance
        self._hpImportance_is_set = not isinstance(hpImportance, Unset)
        self.inProgress = None if isinstance(inProgress, Unset) else inProgress
        self._inProgress_is_set = not isinstance(inProgress, Unset)
        self.pending = None if isinstance(pending, Unset) else pending
        self._pending_is_set = not isinstance(pending, Unset)
...
class TrialFiltersRankWithinExp:
    def __init__(
        ...
        *,
        ...
        self.rank = None if isinstance(rank, Unset) else rank
        self._rank_is_set = not isinstance(rank, Unset)
        self.sorter = None if isinstance(sorter, Unset) else sorter
        self._sorter_is_set = not isinstance(sorter, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._rank_is_set:
            out["rank"] = self.rank
        if not omit_unset or self._sorter_is_set:
...
class UpdateTrialTagsRequestIds:
    def __init__(
        ...
        *,
        ...
        self.ids = None if isinstance(ids, Unset) else ids
        self._ids_is_set = not isinstance(ids, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._ids_is_set:
            out["ids"] = self.ids
        return out
...
class protobufAny:
    def __init__(
        ...
        *,
        ...
        self.typeUrl = None if isinstance(typeUrl, Unset) else typeUrl
        self._typeUrl_is_set = not isinstance(typeUrl, Unset)
        self.value = None if isinstance(value, Unset) else value
        self._value_is_set = not isinstance(value, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._typeUrl_is_set:
            out["typeUrl"] = self.typeUrl
        if not omit_unset or self._value_is_set:
...
class runtimeError:
    def __init__(
        ...
        *,
        ...
        self.code = None if isinstance(code, Unset) else code
        self._code_is_set = not isinstance(code, Unset)
        self.details = None if isinstance(details, Unset) else details
        self._details_is_set = not isinstance(details, Unset)
        self.error = None if isinstance(error, Unset) else error
        self._error_is_set = not isinstance(error, Unset)
        self.message = None if isinstance(message, Unset) else message
        self._message_is_set = not isinstance(message, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._code_is_set:
            out["code"] = self.code
        if not omit_unset or self._details_is_set:
            out["details"] = None if self.details is None else [x.to_json(omit_unset) for x in self.details]
        if not omit_unset or self._error_is_set:
            out["error"] = self.error
        if not omit_unset or self._message_is_set:
...
class runtimeStreamError:
    def __init__(
        ...
        *,
        ...
        self.details = None if isinstance(details, Unset) else details
        self._details_is_set = not isinstance(details, Unset)
        self.grpcCode = None if isinstance(grpcCode, Unset) else grpcCode
        self._grpcCode_is_set = not isinstance(grpcCode, Unset)
        self.httpCode = None if isinstance(httpCode, Unset) else httpCode
        self._httpCode_is_set = not isinstance(httpCode, Unset)
        self.httpStatus = None if isinstance(httpStatus, Unset) else httpStatus
        self._httpStatus_is_set = not isinstance(httpStatus, Unset)
        self.message = None if isinstance(message, Unset) else message
        self._message_is_set = not isinstance(message, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._details_is_set:
            out["details"] = None if self.details is None else [x.to_json(omit_unset) for x in self.details]
        if not omit_unset or self._grpcCode_is_set:
            out["grpcCode"] = self.grpcCode
        if not omit_unset or self._httpCode_is_set:
            out["httpCode"] = self.httpCode
        if not omit_unset or self._httpStatus_is_set:
...
class trialv1Trial:
    def __init__(
        ...
        *,
        ...
        self.bestCheckpoint = None if isinstance(bestCheckpoint, Unset) else bestCheckpoint
        self._bestCheckpoint_is_set = not isinstance(bestCheckpoint, Unset)
        self.bestValidation = None if isinstance(bestValidation, Unset) else bestValidation
        self._bestValidation_is_set = not isinstance(bestValidation, Unset)
        self.endTime = None if isinstance(endTime, Unset) else endTime
        self._endTime_is_set = not isinstance(endTime, Unset)
        self.latestTraining = None if isinstance(latestTraining, Unset) else latestTraining
        self._latestTraining_is_set = not isinstance(latestTraining, Unset)
        self.latestValidation = None if isinstance(latestValidation, Unset) else latestValidation
        self._latestValidation_is_set = not isinstance(latestValidation, Unset)
        self.runnerState = None if isinstance(runnerState, Unset) else runnerState
        self._runnerState_is_set = not isinstance(runnerState, Unset)
        self.taskId = None if isinstance(taskId, Unset) else taskId
        self._taskId_is_set = not isinstance(taskId, Unset)
        self.totalCheckpointSize = None if isinstance(totalCheckpointSize, Unset) else totalCheckpointSize
        self._totalCheckpointSize_is_set = not isinstance(totalCheckpointSize, Unset)
        self.wallClockTime = None if isinstance(wallClockTime, Unset) else wallClockTime
        self._wallClockTime_is_set = not isinstance(wallClockTime, Unset)
        self.warmStartCheckpointUuid = None if isinstance(warmStartCheckpointUuid, Unset) else warmStartCheckpointUuid
        self._warmStartCheckpointUuid_is_set = not isinstance(warmStartCheckpointUuid, Unset)
...
class v1Agent:
    def __init__(
        ...
        *,
        ...
        self.id = id
        self.addresses = None if isinstance(addresses, Unset) else addresses
        self._addresses_is_set = not isinstance(addresses, Unset)
        self.containers = None if isinstance(containers, Unset) else containers
        self._containers_is_set = not isinstance(containers, Unset)
        self.draining = None if isinstance(draining, Unset) else draining
        self._draining_is_set = not isinstance(draining, Unset)
        self.enabled = None if isinstance(enabled, Unset) else enabled
        self._enabled_is_set = not isinstance(enabled, Unset)
        self.label = None if isinstance(label, Unset) else label
        self._label_is_set = not isinstance(label, Unset)
        self.registeredTime = None if isinstance(registeredTime, Unset) else registeredTime
        self._registeredTime_is_set = not isinstance(registeredTime, Unset)
        self.resourcePools = None if isinstance(resourcePools, Unset) else resourcePools
        self._resourcePools_is_set = not isinstance(resourcePools, Unset)
        self.slots = None if isinstance(slots, Unset) else slots
        self._slots_is_set = not isinstance(slots, Unset)
        self.version = None if isinstance(version, Unset) else version
        self._version_is_set = not isinstance(version, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._addresses_is_set:
            out["addresses"] = self.addresses
        if not omit_unset or self._containers_is_set:
            out["containers"] = None if self.containers is None else {k: v.to_json(omit_unset) for k, v in self.containers.items()}
        if not omit_unset or self._draining_is_set:
            out["draining"] = self.draining
        if not omit_unset or self._enabled_is_set:
            out["enabled"] = self.enabled
        if not omit_unset or self._label_is_set:
            out["label"] = self.label
        if not omit_unset or self._registeredTime_is_set:
            out["registeredTime"] = self.registeredTime
        if not omit_unset or self._resourcePools_is_set:
            out["resourcePools"] = self.resourcePools
        if not omit_unset or self._slots_is_set:
            out["slots"] = None if self.slots is None else {k: v.to_json(omit_unset) for k, v in self.slots.items()}
        if not omit_unset or self._version_is_set:
...
class v1AgentUserGroup:
    def __init__(
        ...
        *,
        ...
        self.agentGid = None if isinstance(agentGid, Unset) else agentGid
        self._agentGid_is_set = not isinstance(agentGid, Unset)
        self.agentGroup = None if isinstance(agentGroup, Unset) else agentGroup
        self._agentGroup_is_set = not isinstance(agentGroup, Unset)
        self.agentUid = None if isinstance(agentUid, Unset) else agentUid
        self._agentUid_is_set = not isinstance(agentUid, Unset)
        self.agentUser = None if isinstance(agentUser, Unset) else agentUser
        self._agentUser_is_set = not isinstance(agentUser, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._agentGid_is_set:
            out["agentGid"] = self.agentGid
        if not omit_unset or self._agentGroup_is_set:
            out["agentGroup"] = self.agentGroup
        if not omit_unset or self._agentUid_is_set:
            out["agentUid"] = self.agentUid
        if not omit_unset or self._agentUser_is_set:
...
class v1Allocation:
    def __init__(
        ...
        *,
        ...
        self.allocationId = None if isinstance(allocationId, Unset) else allocationId
        self._allocationId_is_set = not isinstance(allocationId, Unset)
        self.endTime = None if isinstance(endTime, Unset) else endTime
        self._endTime_is_set = not isinstance(endTime, Unset)
        self.isReady = None if isinstance(isReady, Unset) else isReady
        self._isReady_is_set = not isinstance(isReady, Unset)
        self.startTime = None if isinstance(startTime, Unset) else startTime
        self._startTime_is_set = not isinstance(startTime, Unset)
        self.state = None if isinstance(state, Unset) else state
        self._state_is_set = not isinstance(state, Unset)
        self.taskId = None if isinstance(taskId, Unset) else taskId
        self._taskId_is_set = not isinstance(taskId, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._allocationId_is_set:
            out["allocationId"] = self.allocationId
        if not omit_unset or self._endTime_is_set:
            out["endTime"] = self.endTime
        if not omit_unset or self._isReady_is_set:
            out["isReady"] = self.isReady
        if not omit_unset or self._startTime_is_set:
            out["startTime"] = self.startTime
        if not omit_unset or self._state_is_set:
...
class v1AllocationAllGatherRequest:
    def __init__(
        ...
        *,
        ...
        self.allocationId = allocationId
        self.data = data
        self.numPeers = None if isinstance(numPeers, Unset) else numPeers
        self._numPeers_is_set = not isinstance(numPeers, Unset)
        self.requestUuid = None if isinstance(requestUuid, Unset) else requestUuid
        self._requestUuid_is_set = not isinstance(requestUuid, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._numPeers_is_set:
            out["numPeers"] = self.numPeers
        if not omit_unset or self._requestUuid_is_set:
...
class v1AllocationPreemptionSignalResponse:
    def __init__(
        ...
        *,
        ...
        self.preempt = None if isinstance(preempt, Unset) else preempt
        self._preempt_is_set = not isinstance(preempt, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._preempt_is_set:
...
class v1AssignRolesRequest:
    def __init__(
        ...
        *,
        ...
        self.groupRoleAssignments = None if isinstance(groupRoleAssignments, Unset) else groupRoleAssignments
        self._groupRoleAssignments_is_set = not isinstance(groupRoleAssignments, Unset)
        self.userRoleAssignments = None if isinstance(userRoleAssignments, Unset) else userRoleAssignments
        self._userRoleAssignments_is_set = not isinstance(userRoleAssignments, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._groupRoleAssignments_is_set:
        ...
        if not omit_unset or self._userRoleAssignments_is_set:
...
class v1AugmentedTrial:
    def __init__(
        ...
        *,
        ...
        self.rankWithinExp = None if isinstance(rankWithinExp, Unset) else rankWithinExp
        self._rankWithinExp_is_set = not isinstance(rankWithinExp, Unset)
        self.searcherMetric = None if isinstance(searcherMetric, Unset) else searcherMetric
        self._searcherMetric_is_set = not isinstance(searcherMetric, Unset)
        self.searcherMetricLoss = None if isinstance(searcherMetricLoss, Unset) else searcherMetricLoss
        self._searcherMetricLoss_is_set = not isinstance(searcherMetricLoss, Unset)
        self.searcherMetricValue = None if isinstance(searcherMetricValue, Unset) else searcherMetricValue
        self._searcherMetricValue_is_set = not isinstance(searcherMetricValue, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._rankWithinExp_is_set:
            out["rankWithinExp"] = self.rankWithinExp
        if not omit_unset or self._searcherMetric_is_set:
            out["searcherMetric"] = self.searcherMetric
        if not omit_unset or self._searcherMetricLoss_is_set:
            out["searcherMetricLoss"] = None if self.searcherMetricLoss is None else dump_float(self.searcherMetricLoss)
        if not omit_unset or self._searcherMetricValue_is_set:
...
class v1Checkpoint:
    def __init__(
        ...
        *,
        ...
        self.allocationId = None if isinstance(allocationId, Unset) else allocationId
        self._allocationId_is_set = not isinstance(allocationId, Unset)
        self.reportTime = None if isinstance(reportTime, Unset) else reportTime
        self._reportTime_is_set = not isinstance(reportTime, Unset)
        self.taskId = None if isinstance(taskId, Unset) else taskId
        self._taskId_is_set = not isinstance(taskId, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._allocationId_is_set:
            out["allocationId"] = self.allocationId
        if not omit_unset or self._reportTime_is_set:
...
class v1CheckpointTrainingMetadata:
    def __init__(
        ...
        *,
        ...
        self.experimentConfig = None if isinstance(experimentConfig, Unset) else experimentConfig
        self._experimentConfig_is_set = not isinstance(experimentConfig, Unset)
        self.experimentId = None if isinstance(experimentId, Unset) else experimentId
        self._experimentId_is_set = not isinstance(experimentId, Unset)
        self.hparams = None if isinstance(hparams, Unset) else hparams
        self._hparams_is_set = not isinstance(hparams, Unset)
        self.searcherMetric = None if isinstance(searcherMetric, Unset) else searcherMetric
        self._searcherMetric_is_set = not isinstance(searcherMetric, Unset)
        self.trainingMetrics = None if isinstance(trainingMetrics, Unset) else trainingMetrics
        self._trainingMetrics_is_set = not isinstance(trainingMetrics, Unset)
        self.trialId = None if isinstance(trialId, Unset) else trialId
        self._trialId_is_set = not isinstance(trialId, Unset)
        self.validationMetrics = None if isinstance(validationMetrics, Unset) else validationMetrics
        self._validationMetrics_is_set = not isinstance(validationMetrics, Unset)
...
class v1CheckpointWorkload:
    def __init__(
        ...
        *,
        ...
        self.endTime = None if isinstance(endTime, Unset) else endTime
        self._endTime_is_set = not isinstance(endTime, Unset)
        self.metadata = None if isinstance(metadata, Unset) else metadata
        self._metadata_is_set = not isinstance(metadata, Unset)
        self.resources = None if isinstance(resources, Unset) else resources
        self._resources_is_set = not isinstance(resources, Unset)
        self.uuid = None if isinstance(uuid, Unset) else uuid
        self._uuid_is_set = not isinstance(uuid, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._endTime_is_set:
            out["endTime"] = self.endTime
        if not omit_unset or self._metadata_is_set:
            out["metadata"] = self.metadata
        if not omit_unset or self._resources_is_set:
            out["resources"] = self.resources
        if not omit_unset or self._uuid_is_set:
            out["uuid"] = self.uuid
        return out
...
class v1CloseTrialOperation:
    def __init__(
        ...
        *,
        ...
        self.requestId = None if isinstance(requestId, Unset) else requestId
        self._requestId_is_set = not isinstance(requestId, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._requestId_is_set:
...
class v1ColumnFilter:
    def __init__(
        ...
        *,
        ...
        self.filter = None if isinstance(filter, Unset) else filter
        self._filter_is_set = not isinstance(filter, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._filter_is_set:
...
class v1Command:
    def __init__(
        ...
        *,
        ...
        self.container = None if isinstance(container, Unset) else container
        self._container_is_set = not isinstance(container, Unset)
        self.displayName = None if isinstance(displayName, Unset) else displayName
        self._displayName_is_set = not isinstance(displayName, Unset)
        self.exitStatus = None if isinstance(exitStatus, Unset) else exitStatus
        self._exitStatus_is_set = not isinstance(exitStatus, Unset)
        self.userId = None if isinstance(userId, Unset) else userId
        self._userId_is_set = not isinstance(userId, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._container_is_set:
            out["container"] = None if self.container is None else self.container.to_json(omit_unset)
        if not omit_unset or self._displayName_is_set:
            out["displayName"] = self.displayName
        if not omit_unset or self._exitStatus_is_set:
            out["exitStatus"] = self.exitStatus
        if not omit_unset or self._userId_is_set:
...
class v1CompleteValidateAfterOperation:
    def __init__(
        ...
        *,
        ...
        self.op = None if isinstance(op, Unset) else op
        self._op_is_set = not isinstance(op, Unset)
        self.searcherMetric = None if isinstance(searcherMetric, Unset) else searcherMetric
        self._searcherMetric_is_set = not isinstance(searcherMetric, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._op_is_set:
...
class v1Container:
    def __init__(
        ...
        *,
        ...
        self.id = id
        self.state = state
        self.devices = None if isinstance(devices, Unset) else devices
        self._devices_is_set = not isinstance(devices, Unset)
        self.parent = None if isinstance(parent, Unset) else parent
        self._parent_is_set = not isinstance(parent, Unset)
...
class v1CreateExperimentRequest:
    def __init__(
        ...
        *,
        ...
        self.activate = None if isinstance(activate, Unset) else activate
        self._activate_is_set = not isinstance(activate, Unset)
        self.config = None if isinstance(config, Unset) else config
        self._config_is_set = not isinstance(config, Unset)
        self.modelDefinition = None if isinstance(modelDefinition, Unset) else modelDefinition
        self._modelDefinition_is_set = not isinstance(modelDefinition, Unset)
        self.parentId = None if isinstance(parentId, Unset) else parentId
        self._parentId_is_set = not isinstance(parentId, Unset)
        self.projectId = None if isinstance(projectId, Unset) else projectId
        self._projectId_is_set = not isinstance(projectId, Unset)
        self.validateOnly = None if isinstance(validateOnly, Unset) else validateOnly
        self._validateOnly_is_set = not isinstance(validateOnly, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._activate_is_set:
            out["activate"] = self.activate
        if not omit_unset or self._config_is_set:
            out["config"] = self.config
        if not omit_unset or self._modelDefinition_is_set:
            out["modelDefinition"] = None if self.modelDefinition is None else [x.to_json(omit_unset) for x in self.modelDefinition]
        if not omit_unset or self._parentId_is_set:
            out["parentId"] = self.parentId
        if not omit_unset or self._projectId_is_set:
            out["projectId"] = self.projectId
        if not omit_unset or self._validateOnly_is_set:
...
class v1CreateGroupRequest:
    def __init__(
        ...
        *,
        ...
        self.name = name
        self.addUsers = None if isinstance(addUsers, Unset) else addUsers
        self._addUsers_is_set = not isinstance(addUsers, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._addUsers_is_set:
...
class v1CreateTrialOperation:
    def __init__(
        ...
        *,
        ...
        self.hyperparams = None if isinstance(hyperparams, Unset) else hyperparams
        self._hyperparams_is_set = not isinstance(hyperparams, Unset)
        self.requestId = None if isinstance(requestId, Unset) else requestId
        self._requestId_is_set = not isinstance(requestId, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._hyperparams_is_set:
...
class v1CreateTrialsCollectionResponse:
    def __init__(
        ...
        *,
        ...
        self.collection = None if isinstance(collection, Unset) else collection
        self._collection_is_set = not isinstance(collection, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._collection_is_set:
...
class v1Device:
    def __init__(
        ...
        *,
        ...
        self.brand = None if isinstance(brand, Unset) else brand
        self._brand_is_set = not isinstance(brand, Unset)
        self.id = None if isinstance(id, Unset) else id
        self._id_is_set = not isinstance(id, Unset)
        self.type = None if isinstance(type, Unset) else type
        self._type_is_set = not isinstance(type, Unset)
        self.uuid = None if isinstance(uuid, Unset) else uuid
        self._uuid_is_set = not isinstance(uuid, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._brand_is_set:
            out["brand"] = self.brand
        if not omit_unset or self._id_is_set:
            out["id"] = self.id
        if not omit_unset or self._type_is_set:
...
class v1DisableAgentRequest:
    def __init__(
        ...
        *,
        ...
        self.agentId = None if isinstance(agentId, Unset) else agentId
        self._agentId_is_set = not isinstance(agentId, Unset)
        self.drain = None if isinstance(drain, Unset) else drain
        self._drain_is_set = not isinstance(drain, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._agentId_is_set:
            out["agentId"] = self.agentId
        if not omit_unset or self._drain_is_set:
...
class v1DisableAgentResponse:
    def __init__(
        ...
        *,
        ...
        self.agent = None if isinstance(agent, Unset) else agent
        self._agent_is_set = not isinstance(agent, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._agent_is_set:
...
class v1DisableSlotResponse:
    def __init__(
        ...
        *,
        ...
        self.slot = None if isinstance(slot, Unset) else slot
        self._slot_is_set = not isinstance(slot, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._slot_is_set:
...
class v1DoubleFieldFilter:
    def __init__(
        ...
        *,
        ...
        self.gt = None if isinstance(gt, Unset) else gt
        self._gt_is_set = not isinstance(gt, Unset)
        self.gte = None if isinstance(gte, Unset) else gte
        self._gte_is_set = not isinstance(gte, Unset)
        self.lt = None if isinstance(lt, Unset) else lt
        self._lt_is_set = not isinstance(lt, Unset)
        self.lte = None if isinstance(lte, Unset) else lte
        self._lte_is_set = not isinstance(lte, Unset)
...
class v1Experiment:
    def __init__(
        ...
        *,
        ...
        self.state = state
        self.username = username
        self.description = None if isinstance(description, Unset) else description
        self._description_is_set = not isinstance(description, Unset)
        self.displayName = None if isinstance(displayName, Unset) else displayName
        self._displayName_is_set = not isinstance(displayName, Unset)
        self.endTime = None if isinstance(endTime, Unset) else endTime
        self._endTime_is_set = not isinstance(endTime, Unset)
        self.forkedFrom = None if isinstance(forkedFrom, Unset) else forkedFrom
        self._forkedFrom_is_set = not isinstance(forkedFrom, Unset)
        self.labels = None if isinstance(labels, Unset) else labels
        self._labels_is_set = not isinstance(labels, Unset)
        self.notes = None if isinstance(notes, Unset) else notes
        self._notes_is_set = not isinstance(notes, Unset)
        self.parentArchived = None if isinstance(parentArchived, Unset) else parentArchived
        self._parentArchived_is_set = not isinstance(parentArchived, Unset)
        self.progress = None if isinstance(progress, Unset) else progress
        self._progress_is_set = not isinstance(progress, Unset)
        self.projectName = None if isinstance(projectName, Unset) else projectName
        self._projectName_is_set = not isinstance(projectName, Unset)
        self.resourcePool = None if isinstance(resourcePool, Unset) else resourcePool
        self._resourcePool_is_set = not isinstance(resourcePool, Unset)
        self.trialIds = None if isinstance(trialIds, Unset) else trialIds
        self._trialIds_is_set = not isinstance(trialIds, Unset)
        self.userId = None if isinstance(userId, Unset) else userId
        self._userId_is_set = not isinstance(userId, Unset)
        self.workspaceId = None if isinstance(workspaceId, Unset) else workspaceId
        self._workspaceId_is_set = not isinstance(workspaceId, Unset)
        self.workspaceName = None if isinstance(workspaceName, Unset) else workspaceName
        self._workspaceName_is_set = not isinstance(workspaceName, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._description_is_set:
            out["description"] = self.description
        if not omit_unset or self._displayName_is_set:
            out["displayName"] = self.displayName
        if not omit_unset or self._endTime_is_set:
            out["endTime"] = self.endTime
        if not omit_unset or self._forkedFrom_is_set:
            out["forkedFrom"] = self.forkedFrom
        if not omit_unset or self._labels_is_set:
            out["labels"] = self.labels
        if not omit_unset or self._notes_is_set:
            out["notes"] = self.notes
        if not omit_unset or self._parentArchived_is_set:
            out["parentArchived"] = self.parentArchived
        if not omit_unset or self._progress_is_set:
            out["progress"] = None if self.progress is None else dump_float(self.progress)
        if not omit_unset or self._projectName_is_set:
            out["projectName"] = self.projectName
        if not omit_unset or self._resourcePool_is_set:
            out["resourcePool"] = self.resourcePool
        if not omit_unset or self._trialIds_is_set:
            out["trialIds"] = self.trialIds
        if not omit_unset or self._userId_is_set:
            out["userId"] = self.userId
        if not omit_unset or self._workspaceId_is_set:
            out["workspaceId"] = self.workspaceId
        if not omit_unset or self._workspaceName_is_set:
...
class v1ExperimentSimulation:
    def __init__(
        ...
        *,
        ...
        self.config = None if isinstance(config, Unset) else config
        self._config_is_set = not isinstance(config, Unset)
        self.seed = None if isinstance(seed, Unset) else seed
        self._seed_is_set = not isinstance(seed, Unset)
        self.trials = None if isinstance(trials, Unset) else trials
        self._trials_is_set = not isinstance(trials, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._config_is_set:
            out["config"] = self.config
        if not omit_unset or self._seed_is_set:
            out["seed"] = self.seed
        if not omit_unset or self._trials_is_set:
...
class v1FileNode:
    def __init__(
        ...
        *,
        ...
        self.contentLength = None if isinstance(contentLength, Unset) else contentLength
        self._contentLength_is_set = not isinstance(contentLength, Unset)
        self.contentType = None if isinstance(contentType, Unset) else contentType
        self._contentType_is_set = not isinstance(contentType, Unset)
        self.files = None if isinstance(files, Unset) else files
        self._files_is_set = not isinstance(files, Unset)
        self.isDir = None if isinstance(isDir, Unset) else isDir
        self._isDir_is_set = not isinstance(isDir, Unset)
        self.modifiedTime = None if isinstance(modifiedTime, Unset) else modifiedTime
        self._modifiedTime_is_set = not isinstance(modifiedTime, Unset)
        self.name = None if isinstance(name, Unset) else name
        self._name_is_set = not isinstance(name, Unset)
        self.path = None if isinstance(path, Unset) else path
        self._path_is_set = not isinstance(path, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._contentLength_is_set:
            out["contentLength"] = self.contentLength
        if not omit_unset or self._contentType_is_set:
            out["contentType"] = self.contentType
        if not omit_unset or self._files_is_set:
            out["files"] = None if self.files is None else [x.to_json(omit_unset) for x in self.files]
        if not omit_unset or self._isDir_is_set:
            out["isDir"] = self.isDir
        if not omit_unset or self._modifiedTime_is_set:
            out["modifiedTime"] = self.modifiedTime
        if not omit_unset or self._name_is_set:
            out["name"] = self.name
        if not omit_unset or self._path_is_set:
            out["path"] = self.path
        return out
...
class v1GetAgentsResponse:
    def __init__(
        ...
        *,
        ...
        self.agents = None if isinstance(agents, Unset) else agents
        self._agents_is_set = not isinstance(agents, Unset)
        self.pagination = None if isinstance(pagination, Unset) else pagination
        self._pagination_is_set = not isinstance(pagination, Unset)
...
class v1GetBestSearcherValidationMetricResponse:
    def __init__(
        ...
        *,
        ...
        self.metric = None if isinstance(metric, Unset) else metric
        self._metric_is_set = not isinstance(metric, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._metric_is_set:
...
class v1GetCommandResponse:
    def __init__(
        ...
        *,
        ...
        self.command = None if isinstance(command, Unset) else command
        self._command_is_set = not isinstance(command, Unset)
        self.config = None if isinstance(config, Unset) else config
        self._config_is_set = not isinstance(config, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._command_is_set:
...
class v1GetCommandsResponse:
    def __init__(
        ...
        *,
        ...
        self.commands = None if isinstance(commands, Unset) else commands
        self._commands_is_set = not isinstance(commands, Unset)
        self.pagination = None if isinstance(pagination, Unset) else pagination
        self._pagination_is_set = not isinstance(pagination, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._commands_is_set:
...
class v1GetCurrentTrialSearcherOperationResponse:
    def __init__(
        ...
        *,
        ...
        self.completed = None if isinstance(completed, Unset) else completed
        self._completed_is_set = not isinstance(completed, Unset)
        self.op = None if isinstance(op, Unset) else op
        self._op_is_set = not isinstance(op, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._completed_is_set:
...
class v1GetExperimentResponse:
    def __init__(
        ...
        *,
        ...
        self.experiment = experiment
        self.jobSummary = None if isinstance(jobSummary, Unset) else jobSummary
        self._jobSummary_is_set = not isinstance(jobSummary, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._jobSummary_is_set:
...
class v1GetExperimentValidationHistoryResponse:
    def __init__(
        ...
        *,
        ...
        self.validationHistory = None if isinstance(validationHistory, Unset) else validationHistory
        self._validationHistory_is_set = not isinstance(validationHistory, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._validationHistory_is_set:
...
class v1GetGroupsRequest:
    def __init__(
        ...
        *,
        ...
        self.name = None if isinstance(name, Unset) else name
        self._name_is_set = not isinstance(name, Unset)
        self.offset = None if isinstance(offset, Unset) else offset
        self._offset_is_set = not isinstance(offset, Unset)
        self.userId = None if isinstance(userId, Unset) else userId
        self._userId_is_set = not isinstance(userId, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._name_is_set:
            out["name"] = self.name
        if not omit_unset or self._offset_is_set:
...
class v1GetGroupsResponse:
    def __init__(
        ...
        *,
        ...
        self.groups = None if isinstance(groups, Unset) else groups
        self._groups_is_set = not isinstance(groups, Unset)
        self.pagination = None if isinstance(pagination, Unset) else pagination
        self._pagination_is_set = not isinstance(pagination, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._groups_is_set:
...
class v1GetMasterResponse:
    def __init__(
        ...
        *,
        ...
        self.branding = None if isinstance(branding, Unset) else branding
        self._branding_is_set = not isinstance(branding, Unset)
        self.externalLoginUri = None if isinstance(externalLoginUri, Unset) else externalLoginUri
        self._externalLoginUri_is_set = not isinstance(externalLoginUri, Unset)
        self.externalLogoutUri = None if isinstance(externalLogoutUri, Unset) else externalLogoutUri
        self._externalLogoutUri_is_set = not isinstance(externalLogoutUri, Unset)
        self.featureSwitches = None if isinstance(featureSwitches, Unset) else featureSwitches
        self._featureSwitches_is_set = not isinstance(featureSwitches, Unset)
        self.rbacEnabled = None if isinstance(rbacEnabled, Unset) else rbacEnabled
        self._rbacEnabled_is_set = not isinstance(rbacEnabled, Unset)
        self.ssoProviders = None if isinstance(ssoProviders, Unset) else ssoProviders
        self._ssoProviders_is_set = not isinstance(ssoProviders, Unset)
        self.telemetryEnabled = None if isinstance(telemetryEnabled, Unset) else telemetryEnabled
        self._telemetryEnabled_is_set = not isinstance(telemetryEnabled, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._branding_is_set:
            out["branding"] = self.branding
        if not omit_unset or self._externalLoginUri_is_set:
            out["externalLoginUri"] = self.externalLoginUri
        if not omit_unset or self._externalLogoutUri_is_set:
            out["externalLogoutUri"] = self.externalLogoutUri
        if not omit_unset or self._featureSwitches_is_set:
            out["featureSwitches"] = self.featureSwitches
        if not omit_unset or self._rbacEnabled_is_set:
            out["rbacEnabled"] = self.rbacEnabled
        if not omit_unset or self._ssoProviders_is_set:
            out["ssoProviders"] = None if self.ssoProviders is None else [x.to_json(omit_unset) for x in self.ssoProviders]
        if not omit_unset or self._telemetryEnabled_is_set:
...
class v1GetModelDefFileResponse:
    def __init__(
        ...
        *,
        ...
        self.file = None if isinstance(file, Unset) else file
        self._file_is_set = not isinstance(file, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._file_is_set:
            out["file"] = self.file
        return out
...
class v1GetNotebookResponse:
    def __init__(
        ...
        *,
        ...
        self.config = None if isinstance(config, Unset) else config
        self._config_is_set = not isinstance(config, Unset)
        self.notebook = None if isinstance(notebook, Unset) else notebook
        self._notebook_is_set = not isinstance(notebook, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._config_is_set:
            out["config"] = self.config
        if not omit_unset or self._notebook_is_set:
...
class v1GetNotebooksResponse:
    def __init__(
        ...
        *,
        ...
        self.notebooks = None if isinstance(notebooks, Unset) else notebooks
        self._notebooks_is_set = not isinstance(notebooks, Unset)
        self.pagination = None if isinstance(pagination, Unset) else pagination
        self._pagination_is_set = not isinstance(pagination, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._notebooks_is_set:
...
class v1GetRolesByIDRequest:
    def __init__(
        ...
        *,
        ...
        self.roleIds = None if isinstance(roleIds, Unset) else roleIds
        self._roleIds_is_set = not isinstance(roleIds, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._roleIds_is_set:
...
class v1GetRolesByIDResponse:
    def __init__(
        ...
        *,
        ...
        self.roles = None if isinstance(roles, Unset) else roles
        self._roles_is_set = not isinstance(roles, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._roles_is_set:
...
class v1GetSearcherEventsResponse:
    def __init__(
        ...
        *,
        ...
        self.searcherEvents = None if isinstance(searcherEvents, Unset) else searcherEvents
        self._searcherEvents_is_set = not isinstance(searcherEvents, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._searcherEvents_is_set:
...
class v1GetShellResponse:
    def __init__(
        ...
        *,
        ...
        self.config = None if isinstance(config, Unset) else config
        self._config_is_set = not isinstance(config, Unset)
        self.shell = None if isinstance(shell, Unset) else shell
        self._shell_is_set = not isinstance(shell, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._config_is_set:
            out["config"] = self.config
        if not omit_unset or self._shell_is_set:
...
class v1GetShellsResponse:
    def __init__(
        ...
        *,
        ...
        self.pagination = None if isinstance(pagination, Unset) else pagination
        self._pagination_is_set = not isinstance(pagination, Unset)
        self.shells = None if isinstance(shells, Unset) else shells
        self._shells_is_set = not isinstance(shells, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._pagination_is_set:
            out["pagination"] = None if self.pagination is None else self.pagination.to_json(omit_unset)
        if not omit_unset or self._shells_is_set:
...
class v1GetTaskResponse:
    def __init__(
        ...
        *,
        ...
        self.task = None if isinstance(task, Unset) else task
        self._task_is_set = not isinstance(task, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._task_is_set:
...
class v1GetTelemetryResponse:
    def __init__(
        ...
        *,
        ...
        self.segmentKey = None if isinstance(segmentKey, Unset) else segmentKey
        self._segmentKey_is_set = not isinstance(segmentKey, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._segmentKey_is_set:
...
class v1GetTemplateResponse:
    def __init__(
        ...
        *,
        ...
        self.template = None if isinstance(template, Unset) else template
        self._template_is_set = not isinstance(template, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._template_is_set:
...
class v1GetTemplatesResponse:
    def __init__(
        ...
        *,
        ...
        self.pagination = None if isinstance(pagination, Unset) else pagination
        self._pagination_is_set = not isinstance(pagination, Unset)
        self.templates = None if isinstance(templates, Unset) else templates
        self._templates_is_set = not isinstance(templates, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._pagination_is_set:
            out["pagination"] = None if self.pagination is None else self.pagination.to_json(omit_unset)
        if not omit_unset or self._templates_is_set:
...
class v1GetTensorboardResponse:
    def __init__(
        ...
        *,
        ...
        self.config = None if isinstance(config, Unset) else config
        self._config_is_set = not isinstance(config, Unset)
        self.tensorboard = None if isinstance(tensorboard, Unset) else tensorboard
        self._tensorboard_is_set = not isinstance(tensorboard, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._config_is_set:
            out["config"] = self.config
        if not omit_unset or self._tensorboard_is_set:
...
class v1GetTensorboardsResponse:
    def __init__(
        ...
        *,
        ...
        self.pagination = None if isinstance(pagination, Unset) else pagination
        self._pagination_is_set = not isinstance(pagination, Unset)
        self.tensorboards = None if isinstance(tensorboards, Unset) else tensorboards
        self._tensorboards_is_set = not isinstance(tensorboards, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._pagination_is_set:
            out["pagination"] = None if self.pagination is None else self.pagination.to_json(omit_unset)
        if not omit_unset or self._tensorboards_is_set:
...
class v1GetTrialsCollectionsResponse:
    def __init__(
        ...
        *,
        ...
        self.collections = None if isinstance(collections, Unset) else collections
        self._collections_is_set = not isinstance(collections, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._collections_is_set:
...
class v1GetUsersResponse:
    def __init__(
        ...
        *,
        ...
        self.pagination = None if isinstance(pagination, Unset) else pagination
        self._pagination_is_set = not isinstance(pagination, Unset)
        self.users = None if isinstance(users, Unset) else users
        self._users_is_set = not isinstance(users, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._pagination_is_set:
            out["pagination"] = None if self.pagination is None else self.pagination.to_json(omit_unset)
        if not omit_unset or self._users_is_set:
...
class v1Group:
    def __init__(
        ...
        *,
        ...
        self.groupId = None if isinstance(groupId, Unset) else groupId
        self._groupId_is_set = not isinstance(groupId, Unset)
        self.name = None if isinstance(name, Unset) else name
        self._name_is_set = not isinstance(name, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._groupId_is_set:
...
class v1IdleNotebookRequest:
    def __init__(
        ...
        *,
        ...
        self.idle = None if isinstance(idle, Unset) else idle
        self._idle_is_set = not isinstance(idle, Unset)
        self.notebookId = None if isinstance(notebookId, Unset) else notebookId
        self._notebookId_is_set = not isinstance(notebookId, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._idle_is_set:
            out["idle"] = self.idle
        if not omit_unset or self._notebookId_is_set:
...
class v1InitialOperations:
    def __init__(
        ...
        *,
        ...
        self.placeholder = None if isinstance(placeholder, Unset) else placeholder
        self._placeholder_is_set = not isinstance(placeholder, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._placeholder_is_set:
...
class v1Int32FieldFilter:
    def __init__(
        ...
        *,
        ...
        self.gte = None if isinstance(gte, Unset) else gte
        self._gte_is_set = not isinstance(gte, Unset)
        self.incl = None if isinstance(incl, Unset) else incl
        self._incl_is_set = not isinstance(incl, Unset)
        self.lt = None if isinstance(lt, Unset) else lt
        self._lt_is_set = not isinstance(lt, Unset)
        self.lte = None if isinstance(lte, Unset) else lte
        self._lte_is_set = not isinstance(lte, Unset)
        self.notIn = None if isinstance(notIn, Unset) else notIn
        self._notIn_is_set = not isinstance(notIn, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._gte_is_set:
            out["gte"] = self.gte
        if not omit_unset or self._incl_is_set:
            out["incl"] = self.incl
        if not omit_unset or self._lt_is_set:
            out["lt"] = self.lt
        if not omit_unset or self._lte_is_set:
            out["lte"] = self.lte
        if not omit_unset or self._notIn_is_set:
...
class v1Job:
    def __init__(
        ...
        *,
        ...
        self.type = type
        self.username = username
        self.priority = None if isinstance(priority, Unset) else priority
        self._priority_is_set = not isinstance(priority, Unset)
        self.progress = None if isinstance(progress, Unset) else progress
        self._progress_is_set = not isinstance(progress, Unset)
        self.summary = None if isinstance(summary, Unset) else summary
        self._summary_is_set = not isinstance(summary, Unset)
        self.userId = None if isinstance(userId, Unset) else userId
        self._userId_is_set = not isinstance(userId, Unset)
        self.weight = None if isinstance(weight, Unset) else weight
        self._weight_is_set = not isinstance(weight, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._priority_is_set:
            out["priority"] = self.priority
        if not omit_unset or self._progress_is_set:
            out["progress"] = None if self.progress is None else dump_float(self.progress)
        if not omit_unset or self._summary_is_set:
            out["summary"] = None if self.summary is None else self.summary.to_json(omit_unset)
        if not omit_unset or self._userId_is_set:
            out["userId"] = self.userId
        if not omit_unset or self._weight_is_set:
...
class v1K8PriorityClass:
    def __init__(
        ...
        *,
        ...
        self.priorityClass = None if isinstance(priorityClass, Unset) else priorityClass
        self._priorityClass_is_set = not isinstance(priorityClass, Unset)
        self.priorityValue = None if isinstance(priorityValue, Unset) else priorityValue
        self._priorityValue_is_set = not isinstance(priorityValue, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._priorityClass_is_set:
            out["priorityClass"] = self.priorityClass
        if not omit_unset or self._priorityValue_is_set:
...
class v1LaunchCommandRequest:
    def __init__(
        ...
        *,
        ...
        self.config = None if isinstance(config, Unset) else config
        self._config_is_set = not isinstance(config, Unset)
        self.data = None if isinstance(data, Unset) else data
        self._data_is_set = not isinstance(data, Unset)
        self.files = None if isinstance(files, Unset) else files
        self._files_is_set = not isinstance(files, Unset)
        self.templateName = None if isinstance(templateName, Unset) else templateName
        self._templateName_is_set = not isinstance(templateName, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._config_is_set:
            out["config"] = self.config
        if not omit_unset or self._data_is_set:
            out["data"] = self.data
        if not omit_unset or self._files_is_set:
            out["files"] = None if self.files is None else [x.to_json(omit_unset) for x in self.files]
        if not omit_unset or self._templateName_is_set:
...
class v1LaunchNotebookRequest:
    def __init__(
        ...
        *,
        ...
        self.files = None if isinstance(files, Unset) else files
        self._files_is_set = not isinstance(files, Unset)
        self.preview = None if isinstance(preview, Unset) else preview
        self._preview_is_set = not isinstance(preview, Unset)
        self.templateName = None if isinstance(templateName, Unset) else templateName
        self._templateName_is_set = not isinstance(templateName, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._files_is_set:
            out["files"] = None if self.files is None else [x.to_json(omit_unset) for x in self.files]
        if not omit_unset or self._preview_is_set:
...
class v1LaunchTensorboardRequest:
    def __init__(
        ...
        *,
        ...
        self.config = None if isinstance(config, Unset) else config
        self._config_is_set = not isinstance(config, Unset)
        self.experimentIds = None if isinstance(experimentIds, Unset) else experimentIds
        self._experimentIds_is_set = not isinstance(experimentIds, Unset)
        self.files = None if isinstance(files, Unset) else files
        self._files_is_set = not isinstance(files, Unset)
        self.templateName = None if isinstance(templateName, Unset) else templateName
        self._templateName_is_set = not isinstance(templateName, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._config_is_set:
            out["config"] = self.config
        if not omit_unset or self._experimentIds_is_set:
...
class v1LogEntry:
    def __init__(
        ...
        *,
        ...
        self.id = id
        self.level = None if isinstance(level, Unset) else level
        self._level_is_set = not isinstance(level, Unset)
        self.message = None if isinstance(message, Unset) else message
        self._message_is_set = not isinstance(message, Unset)
        self.timestamp = None if isinstance(timestamp, Unset) else timestamp
        self._timestamp_is_set = not isinstance(timestamp, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._level_is_set:
            out["level"] = None if self.level is None else self.level.value
        if not omit_unset or self._message_is_set:
            out["message"] = self.message
        if not omit_unset or self._timestamp_is_set:
...
class v1LoginRequest:
    def __init__(
        ...
        *,
        ...
        self.username = username
        self.isHashed = None if isinstance(isHashed, Unset) else isHashed
        self._isHashed_is_set = not isinstance(isHashed, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._isHashed_is_set:
...
class v1MarkAllocationResourcesDaemonRequest:
    def __init__(
        ...
        *,
        ...
        self.allocationId = allocationId
        self.resourcesId = None if isinstance(resourcesId, Unset) else resourcesId
        self._resourcesId_is_set = not isinstance(resourcesId, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._resourcesId_is_set:
...
class v1MasterLogsResponse:
    def __init__(
        ...
        *,
        ...
        self.logEntry = None if isinstance(logEntry, Unset) else logEntry
        self._logEntry_is_set = not isinstance(logEntry, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._logEntry_is_set:
...
class v1MetricBatchesResponse:
    def __init__(
        ...
        *,
        ...
        self.batches = None if isinstance(batches, Unset) else batches
        self._batches_is_set = not isinstance(batches, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._batches_is_set:
...
class v1Metrics:
    def __init__(
        ...
        *,
        ...
        self.batchMetrics = None if isinstance(batchMetrics, Unset) else batchMetrics
        self._batchMetrics_is_set = not isinstance(batchMetrics, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._batchMetrics_is_set:
...
class v1ModelVersion:
    def __init__(
        ...
        *,
        ...
        self.model = model
        self.version = version
        self.comment = None if isinstance(comment, Unset) else comment
        self._comment_is_set = not isinstance(comment, Unset)
        self.labels = None if isinstance(labels, Unset) else labels
        self._labels_is_set = not isinstance(labels, Unset)
        self.metadata = None if isinstance(metadata, Unset) else metadata
        self._metadata_is_set = not isinstance(metadata, Unset)
        ...
        self.userId = None if isinstance(userId, Unset) else userId
        self._userId_is_set = not isinstance(userId, Unset)
        self.username = None if isinstance(username, Unset) else username
        self._username_is_set = not isinstance(username, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._comment_is_set:
        ...
        if not omit_unset or self._userId_is_set:
            out["userId"] = self.userId
        if not omit_unset or self._username_is_set:
...
class v1Notebook:
    def __init__(
        ...
        *,
        ...
        self.exitStatus = None if isinstance(exitStatus, Unset) else exitStatus
        self._exitStatus_is_set = not isinstance(exitStatus, Unset)
        self.serviceAddress = None if isinstance(serviceAddress, Unset) else serviceAddress
        self._serviceAddress_is_set = not isinstance(serviceAddress, Unset)
        self.userId = None if isinstance(userId, Unset) else userId
        self._userId_is_set = not isinstance(userId, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._exitStatus_is_set:
            out["exitStatus"] = self.exitStatus
        if not omit_unset or self._serviceAddress_is_set:
...
class v1Pagination:
    def __init__(
        ...
        *,
        ...
        self.endIndex = None if isinstance(endIndex, Unset) else endIndex
        self._endIndex_is_set = not isinstance(endIndex, Unset)
        self.limit = None if isinstance(limit, Unset) else limit
        self._limit_is_set = not isinstance(limit, Unset)
        self.offset = None if isinstance(offset, Unset) else offset
        self._offset_is_set = not isinstance(offset, Unset)
        self.startIndex = None if isinstance(startIndex, Unset) else startIndex
        self._startIndex_is_set = not isinstance(startIndex, Unset)
        self.total = None if isinstance(total, Unset) else total
        self._total_is_set = not isinstance(total, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._endIndex_is_set:
            out["endIndex"] = self.endIndex
        if not omit_unset or self._limit_is_set:
            out["limit"] = self.limit
        if not omit_unset or self._offset_is_set:
            out["offset"] = self.offset
        if not omit_unset or self._startIndex_is_set:
            out["startIndex"] = self.startIndex
        if not omit_unset or self._total_is_set:
...
class v1PatchExperimentResponse:
    def __init__(
        ...
        *,
        ...
        self.experiment = None if isinstance(experiment, Unset) else experiment
        self._experiment_is_set = not isinstance(experiment, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._experiment_is_set:
...
class v1PatchModelVersion:
    def __init__(
        ...
        *,
        ...
        self.checkpoint = None if isinstance(checkpoint, Unset) else checkpoint
        self._checkpoint_is_set = not isinstance(checkpoint, Unset)
        self.comment = None if isinstance(comment, Unset) else comment
        self._comment_is_set = not isinstance(comment, Unset)
        self.labels = None if isinstance(labels, Unset) else labels
        self._labels_is_set = not isinstance(labels, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._checkpoint_is_set:
...
class v1PatchTrialsCollectionRequest:
    def __init__(
        ...
        *,
        ...
        self.id = id
        self.filters = None if isinstance(filters, Unset) else filters
        self._filters_is_set = not isinstance(filters, Unset)
        self.name = None if isinstance(name, Unset) else name
        self._name_is_set = not isinstance(name, Unset)
        self.sorter = None if isinstance(sorter, Unset) else sorter
        self._sorter_is_set = not isinstance(sorter, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._filters_is_set:
...
class v1PatchUser:
    def __init__(
        ...
        *,
        ...
        self.active = None if isinstance(active, Unset) else active
        self._active_is_set = not isinstance(active, Unset)
        self.admin = None if isinstance(admin, Unset) else admin
        self._admin_is_set = not isinstance(admin, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._active_is_set:
            out["active"] = self.active
        if not omit_unset or self._admin_is_set:
...
class v1Permission:
    def __init__(
        ...
        *,
        id: "v1PermissionType",
        isGlobal: "typing.Union[bool, None, Unset]" = _unset,
        name: "typing.Union[str, None, Unset]" = _unset,
    ):
        self.id = id
        self.isGlobal = None if isinstance(isGlobal, Unset) else isGlobal
        self._isGlobal_is_set = not isinstance(isGlobal, Unset)
        self.name = None if isinstance(name, Unset) else name
        self._name_is_set = not isinstance(name, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._isGlobal_is_set:
            out["isGlobal"] = self.isGlobal
        if not omit_unset or self._name_is_set:
            out["name"] = self.name
        return out
...
class v1PostAllocationProxyAddressRequest:
    def __init__(
        ...
        *,
        ...
        self.allocationId = None if isinstance(allocationId, Unset) else allocationId
        self._allocationId_is_set = not isinstance(allocationId, Unset)
        self.proxyAddress = None if isinstance(proxyAddress, Unset) else proxyAddress
        self._proxyAddress_is_set = not isinstance(proxyAddress, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._allocationId_is_set:
            out["allocationId"] = self.allocationId
        if not omit_unset or self._proxyAddress_is_set:
...
class v1PostSearcherOperationsRequest:
    def __init__(
        ...
        *,
        ...
        self.experimentId = None if isinstance(experimentId, Unset) else experimentId
        self._experimentId_is_set = not isinstance(experimentId, Unset)
        self.searcherOperations = None if isinstance(searcherOperations, Unset) else searcherOperations
        self._searcherOperations_is_set = not isinstance(searcherOperations, Unset)
        self.triggeredByEvent = None if isinstance(triggeredByEvent, Unset) else triggeredByEvent
        self._triggeredByEvent_is_set = not isinstance(triggeredByEvent, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._experimentId_is_set:
            out["experimentId"] = self.experimentId
        if not omit_unset or self._searcherOperations_is_set:
        ...
        if not omit_unset or self._triggeredByEvent_is_set:
...
class v1PostUserRequest:
    def __init__(
        ...
        *,
        ...
        self.password = None if isinstance(password, Unset) else password
        self._password_is_set = not isinstance(password, Unset)
        self.user = None if isinstance(user, Unset) else user
        self._user_is_set = not isinstance(user, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._password_is_set:
            out["password"] = self.password
        if not omit_unset or self._user_is_set:
...
class v1PreviewHPSearchResponse:
    def __init__(
        ...
        *,
        ...
        self.simulation = None if isinstance(simulation, Unset) else simulation
        self._simulation_is_set = not isinstance(simulation, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._simulation_is_set:
...
class v1Project:
    def __init__(
        ...
        *,
        ...
        self.description = None if isinstance(description, Unset) else description
        self._description_is_set = not isinstance(description, Unset)
        self.lastExperimentStartedAt = None if isinstance(lastExperimentStartedAt, Unset) else lastExperimentStartedAt
        self._lastExperimentStartedAt_is_set = not isinstance(lastExperimentStartedAt, Unset)
        self.workspaceName = None if isinstance(workspaceName, Unset) else workspaceName
        self._workspaceName_is_set = not isinstance(workspaceName, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._description_is_set:
            out["description"] = self.description
        if not omit_unset or self._lastExperimentStartedAt_is_set:
...
class v1QueueControl:
    def __init__(
        ...
        *,
        ...
        self.jobId = jobId
        self.aheadOf = None if isinstance(aheadOf, Unset) else aheadOf
        self._aheadOf_is_set = not isinstance(aheadOf, Unset)
        self.behindOf = None if isinstance(behindOf, Unset) else behindOf
        self._behindOf_is_set = not isinstance(behindOf, Unset)
        self.priority = None if isinstance(priority, Unset) else priority
        self._priority_is_set = not isinstance(priority, Unset)
        self.resourcePool = None if isinstance(resourcePool, Unset) else resourcePool
        self._resourcePool_is_set = not isinstance(resourcePool, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._aheadOf_is_set:
            out["aheadOf"] = self.aheadOf
        if not omit_unset or self._behindOf_is_set:
...
class v1RPQueueStat:
    def __init__(
        ...
        *,
        ...
        self.resourcePool = resourcePool
        self.stats = stats
        self.aggregates = None if isinstance(aggregates, Unset) else aggregates
        self._aggregates_is_set = not isinstance(aggregates, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._aggregates_is_set:
...
class v1ResourceAllocationRawEntry:
    def __init__(
        ...
        *,
        ...
        self.experimentId = None if isinstance(experimentId, Unset) else experimentId
        self._experimentId_is_set = not isinstance(experimentId, Unset)
        self.kind = None if isinstance(kind, Unset) else kind
        self._kind_is_set = not isinstance(kind, Unset)
        self.labels = None if isinstance(labels, Unset) else labels
        self._labels_is_set = not isinstance(labels, Unset)
        self.seconds = None if isinstance(seconds, Unset) else seconds
        self._seconds_is_set = not isinstance(seconds, Unset)
        self.slots = None if isinstance(slots, Unset) else slots
        self._slots_is_set = not isinstance(slots, Unset)
        self.startTime = None if isinstance(startTime, Unset) else startTime
        self._startTime_is_set = not isinstance(startTime, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._experimentId_is_set:
            out["experimentId"] = self.experimentId
        if not omit_unset or self._kind_is_set:
            out["kind"] = self.kind
        if not omit_unset or self._labels_is_set:
            out["labels"] = self.labels
        if not omit_unset or self._seconds_is_set:
...
class v1ResourceAllocationRawResponse:
    def __init__(
        ...
        *,
        ...
        self.resourceEntries = None if isinstance(resourceEntries, Unset) else resourceEntries
        self._resourceEntries_is_set = not isinstance(resourceEntries, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._resourceEntries_is_set:
...
class v1ResourcePool:
    def __init__(
        ...
        *,
        ...
        self.type = type
        self.accelerator = None if isinstance(accelerator, Unset) else accelerator
        self._accelerator_is_set = not isinstance(accelerator, Unset)
        self.slotsPerAgent = None if isinstance(slotsPerAgent, Unset) else slotsPerAgent
        self._slotsPerAgent_is_set = not isinstance(slotsPerAgent, Unset)
        self.stats = None if isinstance(stats, Unset) else stats
        self._stats_is_set = not isinstance(stats, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._accelerator_is_set:
            out["accelerator"] = self.accelerator
        if not omit_unset or self._slotsPerAgent_is_set:
            out["slotsPerAgent"] = self.slotsPerAgent
        if not omit_unset or self._stats_is_set:
...
class v1ResourcePoolAwsDetail:
    def __init__(
        ...
        *,
        ...
        self.customTags = None if isinstance(customTags, Unset) else customTags
        self._customTags_is_set = not isinstance(customTags, Unset)
        self.instanceType = None if isinstance(instanceType, Unset) else instanceType
        self._instanceType_is_set = not isinstance(instanceType, Unset)
        self.logGroup = None if isinstance(logGroup, Unset) else logGroup
        self._logGroup_is_set = not isinstance(logGroup, Unset)
        self.logStream = None if isinstance(logStream, Unset) else logStream
        self._logStream_is_set = not isinstance(logStream, Unset)
        self.spotMaxPrice = None if isinstance(spotMaxPrice, Unset) else spotMaxPrice
        self._spotMaxPrice_is_set = not isinstance(spotMaxPrice, Unset)
        self.subnetId = None if isinstance(subnetId, Unset) else subnetId
        self._subnetId_is_set = not isinstance(subnetId, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._customTags_is_set:
            out["customTags"] = None if self.customTags is None else [x.to_json(omit_unset) for x in self.customTags]
        if not omit_unset or self._instanceType_is_set:
            out["instanceType"] = self.instanceType
        if not omit_unset or self._logGroup_is_set:
            out["logGroup"] = self.logGroup
        if not omit_unset or self._logStream_is_set:
            out["logStream"] = self.logStream
        if not omit_unset or self._spotMaxPrice_is_set:
            out["spotMaxPrice"] = self.spotMaxPrice
        if not omit_unset or self._subnetId_is_set:
...
class v1ResourcePoolDetail:
    def __init__(
        ...
        *,
        ...
        self.aws = None if isinstance(aws, Unset) else aws
        self._aws_is_set = not isinstance(aws, Unset)
        self.gcp = None if isinstance(gcp, Unset) else gcp
        self._gcp_is_set = not isinstance(gcp, Unset)
        self.priorityScheduler = None if isinstance(priorityScheduler, Unset) else priorityScheduler
        self._priorityScheduler_is_set = not isinstance(priorityScheduler, Unset)
...
class v1ResourcePoolGcpDetail:
    def __init__(
        ...
        *,
        ...
        self.zone = zone
        self.networkTags = None if isinstance(networkTags, Unset) else networkTags
        self._networkTags_is_set = not isinstance(networkTags, Unset)
        self.subnetwork = None if isinstance(subnetwork, Unset) else subnetwork
        self._subnetwork_is_set = not isinstance(subnetwork, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._networkTags_is_set:
            out["networkTags"] = self.networkTags
        if not omit_unset or self._subnetwork_is_set:
...
class v1ResourcePoolPrioritySchedulerDetail:
    def __init__(
        ...
        *,
        ...
        self.k8Priorities = None if isinstance(k8Priorities, Unset) else k8Priorities
        self._k8Priorities_is_set = not isinstance(k8Priorities, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._k8Priorities_is_set:
...
class v1Role:
    def __init__(
        ...
        *,
        ...
        self.name = None if isinstance(name, Unset) else name
        self._name_is_set = not isinstance(name, Unset)
        self.permissions = None if isinstance(permissions, Unset) else permissions
        self._permissions_is_set = not isinstance(permissions, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._name_is_set:
            out["name"] = self.name
        if not omit_unset or self._permissions_is_set:
...
class v1RoleAssignment:
    def __init__(
        ...
        *,
        ...
        self.role = role
        self.scopeWorkspaceId = None if isinstance(scopeWorkspaceId, Unset) else scopeWorkspaceId
        self._scopeWorkspaceId_is_set = not isinstance(scopeWorkspaceId, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._scopeWorkspaceId_is_set:
...
class v1RoleAssignmentSummary:
    def __init__(
        ...
        *,
        ...
        self.isGlobal = None if isinstance(isGlobal, Unset) else isGlobal
        self._isGlobal_is_set = not isinstance(isGlobal, Unset)
        self.scopeWorkspaceIds = None if isinstance(scopeWorkspaceIds, Unset) else scopeWorkspaceIds
        self._scopeWorkspaceIds_is_set = not isinstance(scopeWorkspaceIds, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._isGlobal_is_set:
            out["isGlobal"] = self.isGlobal
        if not omit_unset or self._scopeWorkspaceIds_is_set:
...
class v1RoleWithAssignments:
    def __init__(
        ...
        *,
        ...
        self.groupRoleAssignments = None if isinstance(groupRoleAssignments, Unset) else groupRoleAssignments
        self._groupRoleAssignments_is_set = not isinstance(groupRoleAssignments, Unset)
        self.role = None if isinstance(role, Unset) else role
        self._role_is_set = not isinstance(role, Unset)
        self.userRoleAssignments = None if isinstance(userRoleAssignments, Unset) else userRoleAssignments
        self._userRoleAssignments_is_set = not isinstance(userRoleAssignments, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._groupRoleAssignments_is_set:
            out["groupRoleAssignments"] = None if self.groupRoleAssignments is None else [x.to_json(omit_unset) for x in self.groupRoleAssignments]
        if not omit_unset or self._role_is_set:
...
class v1RunnableOperation:
    def __init__(
        ...
        *,
        ...
        self.length = None if isinstance(length, Unset) else length
        self._length_is_set = not isinstance(length, Unset)
        self.type = None if isinstance(type, Unset) else type
        self._type_is_set = not isinstance(type, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._length_is_set:
...
class v1SearcherEvent:
    def __init__(
        ...
        *,
        ...
        self.id = id
        self.experimentInactive = None if isinstance(experimentInactive, Unset) else experimentInactive
        self._experimentInactive_is_set = not isinstance(experimentInactive, Unset)
        self.initialOperations = None if isinstance(initialOperations, Unset) else initialOperations
        self._initialOperations_is_set = not isinstance(initialOperations, Unset)
        self.trialClosed = None if isinstance(trialClosed, Unset) else trialClosed
        self._trialClosed_is_set = not isinstance(trialClosed, Unset)
        self.trialCreated = None if isinstance(trialCreated, Unset) else trialCreated
        self._trialCreated_is_set = not isinstance(trialCreated, Unset)
        self.trialExitedEarly = None if isinstance(trialExitedEarly, Unset) else trialExitedEarly
        self._trialExitedEarly_is_set = not isinstance(trialExitedEarly, Unset)
        self.trialProgress = None if isinstance(trialProgress, Unset) else trialProgress
        self._trialProgress_is_set = not isinstance(trialProgress, Unset)
        self.validationCompleted = None if isinstance(validationCompleted, Unset) else validationCompleted
        self._validationCompleted_is_set = not isinstance(validationCompleted, Unset)
...
class v1SearcherOperation:
    def __init__(
        ...
        *,
        ...
        self.closeTrial = None if isinstance(closeTrial, Unset) else closeTrial
        self._closeTrial_is_set = not isinstance(closeTrial, Unset)
        self.createTrial = None if isinstance(createTrial, Unset) else createTrial
        self._createTrial_is_set = not isinstance(createTrial, Unset)
        self.setSearcherProgress = None if isinstance(setSearcherProgress, Unset) else setSearcherProgress
        self._setSearcherProgress_is_set = not isinstance(setSearcherProgress, Unset)
        self.shutDown = None if isinstance(shutDown, Unset) else shutDown
        self._shutDown_is_set = not isinstance(shutDown, Unset)
        self.trialOperation = None if isinstance(trialOperation, Unset) else trialOperation
        self._trialOperation_is_set = not isinstance(trialOperation, Unset)
...
class v1SetCommandPriorityRequest:
    def __init__(
        ...
        *,
        ...
        self.commandId = None if isinstance(commandId, Unset) else commandId
        self._commandId_is_set = not isinstance(commandId, Unset)
        self.priority = None if isinstance(priority, Unset) else priority
        self._priority_is_set = not isinstance(priority, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._commandId_is_set:
...
class v1SetShellPriorityRequest:
    def __init__(
        ...
        *,
        ...
        self.priority = None if isinstance(priority, Unset) else priority
        self._priority_is_set = not isinstance(priority, Unset)
        self.shellId = None if isinstance(shellId, Unset) else shellId
        self._shellId_is_set = not isinstance(shellId, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._priority_is_set:
            out["priority"] = self.priority
        if not omit_unset or self._shellId_is_set:
...
class v1SetTensorboardPriorityRequest:
    def __init__(
        ...
        *,
        ...
        self.priority = None if isinstance(priority, Unset) else priority
        self._priority_is_set = not isinstance(priority, Unset)
        self.tensorboardId = None if isinstance(tensorboardId, Unset) else tensorboardId
        self._tensorboardId_is_set = not isinstance(tensorboardId, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._priority_is_set:
            out["priority"] = self.priority
        if not omit_unset or self._tensorboardId_is_set:
...
class v1Shell:
    def __init__(
        ...
        *,
        ...
        self.exitStatus = None if isinstance(exitStatus, Unset) else exitStatus
        self._exitStatus_is_set = not isinstance(exitStatus, Unset)
        self.privateKey = None if isinstance(privateKey, Unset) else privateKey
        self._privateKey_is_set = not isinstance(privateKey, Unset)
        self.publicKey = None if isinstance(publicKey, Unset) else publicKey
        self._publicKey_is_set = not isinstance(publicKey, Unset)
        self.userId = None if isinstance(userId, Unset) else userId
        self._userId_is_set = not isinstance(userId, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._exitStatus_is_set:
            out["exitStatus"] = self.exitStatus
        if not omit_unset or self._privateKey_is_set:
            out["privateKey"] = self.privateKey
        if not omit_unset or self._publicKey_is_set:
...
class v1Slot:
    def __init__(
        ...
        *,
        ...
        self.container = None if isinstance(container, Unset) else container
        self._container_is_set = not isinstance(container, Unset)
        self.device = None if isinstance(device, Unset) else device
        self._device_is_set = not isinstance(device, Unset)
        self.draining = None if isinstance(draining, Unset) else draining
        self._draining_is_set = not isinstance(draining, Unset)
        self.enabled = None if isinstance(enabled, Unset) else enabled
        self._enabled_is_set = not isinstance(enabled, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._container_is_set:
            out["container"] = None if self.container is None else self.container.to_json(omit_unset)
        if not omit_unset or self._device_is_set:
...
class v1Task:
    def __init__(
        ...
        *,
        ...
        self.allocations = None if isinstance(allocations, Unset) else allocations
        self._allocations_is_set = not isinstance(allocations, Unset)
        self.taskId = None if isinstance(taskId, Unset) else taskId
        self._taskId_is_set = not isinstance(taskId, Unset)
        self.taskType = None if isinstance(taskType, Unset) else taskType
        self._taskType_is_set = not isinstance(taskType, Unset)
...
class v1TaskLogsFieldsResponse:
    def __init__(
        ...
        *,
        ...
        self.agentIds = None if isinstance(agentIds, Unset) else agentIds
        self._agentIds_is_set = not isinstance(agentIds, Unset)
        self.allocationIds = None if isinstance(allocationIds, Unset) else allocationIds
        self._allocationIds_is_set = not isinstance(allocationIds, Unset)
        self.containerIds = None if isinstance(containerIds, Unset) else containerIds
        self._containerIds_is_set = not isinstance(containerIds, Unset)
        self.rankIds = None if isinstance(rankIds, Unset) else rankIds
        self._rankIds_is_set = not isinstance(rankIds, Unset)
        self.sources = None if isinstance(sources, Unset) else sources
        self._sources_is_set = not isinstance(sources, Unset)
        self.stdtypes = None if isinstance(stdtypes, Unset) else stdtypes
        self._stdtypes_is_set = not isinstance(stdtypes, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._agentIds_is_set:
            out["agentIds"] = self.agentIds
        if not omit_unset or self._allocationIds_is_set:
            out["allocationIds"] = self.allocationIds
        if not omit_unset or self._containerIds_is_set:
            out["containerIds"] = self.containerIds
        if not omit_unset or self._rankIds_is_set:
            out["rankIds"] = self.rankIds
        if not omit_unset or self._sources_is_set:
            out["sources"] = self.sources
        if not omit_unset or self._stdtypes_is_set:
...
class v1TrialFilters:
    def __init__(
        ...
        *,
        ...
        self.hparams = None if isinstance(hparams, Unset) else hparams
        self._hparams_is_set = not isinstance(hparams, Unset)
        self.projectIds = None if isinstance(projectIds, Unset) else projectIds
        self._projectIds_is_set = not isinstance(projectIds, Unset)
        self.rankWithinExp = None if isinstance(rankWithinExp, Unset) else rankWithinExp
        self._rankWithinExp_is_set = not isinstance(rankWithinExp, Unset)
        self.searcher = None if isinstance(searcher, Unset) else searcher
        self._searcher_is_set = not isinstance(searcher, Unset)
        self.searcherMetric = None if isinstance(searcherMetric, Unset) else searcherMetric
        self._searcherMetric_is_set = not isinstance(searcherMetric, Unset)
        self.searcherMetricValue = None if isinstance(searcherMetricValue, Unset) else searcherMetricValue
        self._searcherMetricValue_is_set = not isinstance(searcherMetricValue, Unset)
        self.startTime = None if isinstance(startTime, Unset) else startTime
        self._startTime_is_set = not isinstance(startTime, Unset)
        self.states = None if isinstance(states, Unset) else states
        self._states_is_set = not isinstance(states, Unset)
        self.tags = None if isinstance(tags, Unset) else tags
        self._tags_is_set = not isinstance(tags, Unset)
        self.trainingMetrics = None if isinstance(trainingMetrics, Unset) else trainingMetrics
        self._trainingMetrics_is_set = not isinstance(trainingMetrics, Unset)
        self.trialIds = None if isinstance(trialIds, Unset) else trialIds
        self._trialIds_is_set = not isinstance(trialIds, Unset)
        self.userIds = None if isinstance(userIds, Unset) else userIds
        self._userIds_is_set = not isinstance(userIds, Unset)
        self.validationMetrics = None if isinstance(validationMetrics, Unset) else validationMetrics
        self._validationMetrics_is_set = not isinstance(validationMetrics, Unset)
        self.workspaceIds = None if isinstance(workspaceIds, Unset) else workspaceIds
        self._workspaceIds_is_set = not isinstance(workspaceIds, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._projectIds_is_set:
        ...
        if not omit_unset or self._searcher_is_set:
        ...
        if not omit_unset or self._states_is_set:
            out["states"] = None if self.states is None else [x.value for x in self.states]
        if not omit_unset or self._tags_is_set:
        ...
        if not omit_unset or self._trialIds_is_set:
            out["trialIds"] = self.trialIds
        if not omit_unset or self._userIds_is_set:
        ...
        if not omit_unset or self._workspaceIds_is_set:
...
class v1TrialOperation:
    def __init__(
        ...
        *,
        ...
        self.validateAfter = None if isinstance(validateAfter, Unset) else validateAfter
        self._validateAfter_is_set = not isinstance(validateAfter, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._validateAfter_is_set:
...
class v1TrialPatch:
    def __init__(
        ...
        *,
        ...
        self.addTag = None if isinstance(addTag, Unset) else addTag
        self._addTag_is_set = not isinstance(addTag, Unset)
        self.removeTag = None if isinstance(removeTag, Unset) else removeTag
        self._removeTag_is_set = not isinstance(removeTag, Unset)
...
class v1TrialProfilerMetricLabels:
    def __init__(
        ...
        *,
        ...
        self.agentId = None if isinstance(agentId, Unset) else agentId
        self._agentId_is_set = not isinstance(agentId, Unset)
        self.gpuUuid = None if isinstance(gpuUuid, Unset) else gpuUuid
        self._gpuUuid_is_set = not isinstance(gpuUuid, Unset)
        self.metricType = None if isinstance(metricType, Unset) else metricType
        self._metricType_is_set = not isinstance(metricType, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._agentId_is_set:
            out["agentId"] = self.agentId
        if not omit_unset or self._gpuUuid_is_set:
            out["gpuUuid"] = self.gpuUuid
        if not omit_unset or self._metricType_is_set:
...
class v1TrialSimulation:
    def __init__(
        ...
        *,
        ...
        self.occurrences = None if isinstance(occurrences, Unset) else occurrences
        self._occurrences_is_set = not isinstance(occurrences, Unset)
        self.operations = None if isinstance(operations, Unset) else operations
        self._operations_is_set = not isinstance(operations, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._occurrences_is_set:
            out["occurrences"] = self.occurrences
        if not omit_unset or self._operations_is_set:
...
class v1TrialSorter:
    def __init__(
        ...
        *,
        ...
        self.orderBy = None if isinstance(orderBy, Unset) else orderBy
        self._orderBy_is_set = not isinstance(orderBy, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._orderBy_is_set:
...
class v1Trigger:
    def __init__(
        ...
        *,
        ...
        self.condition = None if isinstance(condition, Unset) else condition
        self._condition_is_set = not isinstance(condition, Unset)
        self.id = None if isinstance(id, Unset) else id
        self._id_is_set = not isinstance(id, Unset)
        self.triggerType = None if isinstance(triggerType, Unset) else triggerType
        self._triggerType_is_set = not isinstance(triggerType, Unset)
        self.webhookId = None if isinstance(webhookId, Unset) else webhookId
        self._webhookId_is_set = not isinstance(webhookId, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._condition_is_set:
            out["condition"] = self.condition
        if not omit_unset or self._id_is_set:
            out["id"] = self.id
        if not omit_unset or self._triggerType_is_set:
            out["triggerType"] = None if self.triggerType is None else self.triggerType.value
        if not omit_unset or self._webhookId_is_set:
...
class v1UpdateGroupRequest:
    def __init__(
        ...
        *,
        ...
        self.name = None if isinstance(name, Unset) else name
        self._name_is_set = not isinstance(name, Unset)
        self.removeUsers = None if isinstance(removeUsers, Unset) else removeUsers
        self._removeUsers_is_set = not isinstance(removeUsers, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._name_is_set:
            out["name"] = self.name
        if not omit_unset or self._removeUsers_is_set:
...
class v1UpdateTrialTagsRequest:
    def __init__(
        ...
        *,
        ...
        self.filters = None if isinstance(filters, Unset) else filters
        self._filters_is_set = not isinstance(filters, Unset)
        self.trial = None if isinstance(trial, Unset) else trial
        self._trial_is_set = not isinstance(trial, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._filters_is_set:
            out["filters"] = None if self.filters is None else self.filters.to_json(omit_unset)
        if not omit_unset or self._trial_is_set:
...
class v1UpdateTrialTagsResponse:
    def __init__(
        ...
        *,
        ...
        self.rowsAffected = None if isinstance(rowsAffected, Unset) else rowsAffected
        self._rowsAffected_is_set = not isinstance(rowsAffected, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._rowsAffected_is_set:
...
class v1User:
    def __init__(
        ...
        *,
        ...
        self.id = None if isinstance(id, Unset) else id
        self._id_is_set = not isinstance(id, Unset)
        self.modifiedAt = None if isinstance(modifiedAt, Unset) else modifiedAt
        self._modifiedAt_is_set = not isinstance(modifiedAt, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._id_is_set:
            out["id"] = self.id
        if not omit_unset or self._modifiedAt_is_set:
...
class v1UserWebSetting:
    def __init__(
        ...
        *,
        ...
        self.key = key
        self.storagePath = None if isinstance(storagePath, Unset) else storagePath
        self._storagePath_is_set = not isinstance(storagePath, Unset)
        self.value = None if isinstance(value, Unset) else value
        self._value_is_set = not isinstance(value, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._storagePath_is_set:
...
class v1Webhook:
    def __init__(
        ...
        *,
        ...
        self.id = None if isinstance(id, Unset) else id
        self._id_is_set = not isinstance(id, Unset)
        self.triggers = None if isinstance(triggers, Unset) else triggers
        self._triggers_is_set = not isinstance(triggers, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._id_is_set:
            out["id"] = self.id
        if not omit_unset or self._triggers_is_set:
...
class v1WorkloadContainer:
    def __init__(
        ...
        *,
        ...
        self.checkpoint = None if isinstance(checkpoint, Unset) else checkpoint
        self._checkpoint_is_set = not isinstance(checkpoint, Unset)
        self.training = None if isinstance(training, Unset) else training
        self._training_is_set = not isinstance(training, Unset)
        self.validation = None if isinstance(validation, Unset) else validation
        self._validation_is_set = not isinstance(validation, Unset)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Any:
        ...
        if not omit_unset or self._checkpoint_is_set:
            out["checkpoint"] = None if self.checkpoint is None else self.checkpoint.to_json(omit_unset)
        if not omit_unset or self._training_is_set:
            out["training"] = None if self.training is None else self.training.to_json(omit_unset)
        if not omit_unset or self._validation_is_set:
