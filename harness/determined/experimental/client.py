...
@_require_singleton
def get_trials_training_metrics(trial_ids: List[int]) -> Iterable[TrainingMetrics]:
    """
    ...
    """
    assert _determined is not None
    return _determined.get_trials_training_metrics(trial_ids)


@_require_singleton
def get_trials_validation_metrics(trial_ids: List[int]) -> Iterable[ValidationMetrics]:
    """
    ...
    """
    assert _determined is not None
    return _determined.get_trials_validation_metrics(trial_ids)
