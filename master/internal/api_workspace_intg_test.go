...
func TestAuthzGetWorkspace(t *testing.T) {
	...
	workspaceAuthZ.On("CanGetWorkspace", mock.Anything, mock.Anything).Return(false).Once()
...
func TestAuthzPostWorkspace(t *testing.T) {
	...
	workspaceAuthZ.On("CanCreateWorkspace", mock.Anything).Return(nil).Once()
	workspaceAuthZ.On("CanGetWorkspace", mock.Anything, mock.Anything).Return(true).Once()
